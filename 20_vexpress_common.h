...
#elif defined(CONFIG_VEXPRESS_EXTENDED_MEMORY_MAP)CONFIG_EXTRA_ENV_SETTINGS
...
#define CONFIG_BOOTCOMMAND "fatload mmc 0:1 0x60000000 uImage; setenv bootargs ß'root=/dev/mmcblk0p2 rw console=ttyAMA0,38400n8'; bootm 0x60000000"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
		...
		"bootflash=fatload mmc 0:1 0x60000000 uImage; " \
			"run flashargs; " \
			"bootm 0x60000000"
